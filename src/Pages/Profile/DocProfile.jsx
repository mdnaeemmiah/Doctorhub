import img from '../../assets/gettyimages-898343438-612x612.jpg'

const DocProfile = () => {
    return ( 
        <div className='md:h-[300px] shadow-lg border border-red-600 py-10 '>
            <div className="  p-8 sm:flex sm:space-x-6 dark:bg-gray-50 dark:text-gray-800">
                <div className=" w-full mb-6 h-56 sm:h-32 sm:w-32 sm:mb-0">
